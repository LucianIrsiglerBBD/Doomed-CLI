...
public class WeaponService {
    ...
    if (weapon.getFireRate() < 0) throw new ValidationException("Fire rate cannot be negative");
    if (weapon.getDamage() < 0) throw new ValidationException("Damage cannot be negative");
}
